  ...
  return (
    <SectionContainer className="bg-Gray pb-20">
      ...
      <header id="features" className="max-w-md mx-auto pt-20">
        <h3 className="text-center text-VeryDarkBlue font-bold text-[1.7rem] md:text-4xl">
          Advanced Statistics
        </h3>
        <p className="text-center text-gray-500 mt-3 mb-24">
      ...
      <main className="flex lg:flex-row flex-col gap-x-8 gap-y-10 justify-center items-center lg:justify-normal lg:items-start">
        <article className="flex flex-col bg-white pb-8 pt-16 px-6 rounded-md relative max-w-[350px] max-h-80 lg:max-h-60">
          ...
          <h4 className="text-VeryDarkBlue font-bold text-2xl text-center lg:text-left">
            Brand Recognition
          </h4>
          <p className="text-GrayishViolet mt-3 text-center lg:text-left">
