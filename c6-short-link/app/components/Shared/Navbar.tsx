    ...
    <SectionContainer>
      <nav className='hidden justify-between pt-6 lg:flex'>
        ...
        <aside className="hidden lg:flex gap-x-6 justify-center items-center">
          <button className="text-GrayishViolet lg:hover:text-VeryDarkBlue transition-colors">Login</button>
          <button className="text-white font-bold bg-Cyan rounded-full px-6 py-2 lg:hover:brightness-110 transition">Sign Up</button>
        </aside>
      </nav>
      ...
      <nav className='flex py-4 justify-between lg:hidden'>
        ...
        {!isMenuOpen
          ...
          : <>
              ...
              <ul className={`lg:hidden top-14 flex flex-col justify-center items-center gap-y-4 
              ...
              ${isMenuOpen ? 'absolute scale-100' : 'scale-0'}`}>
                ...
                <button>Login</button>
                <button className="font-bold bg-Cyan rounded-full w-full py-2">Sign Up</button>
              </ul>
            </>
        }
      </nav>
